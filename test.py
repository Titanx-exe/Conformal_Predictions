...
ABS_PROJECT_ROOT = "/upb/users/h/hpurohit/profiles/unix/cs/RR_Retrieval/Robust_Ranking/RobustRanking"

if not os.path.exists(os.path.join(project_root, "data")) and os.path.exists(ABS_PROJECT_ROOT):
