...
class Qwen3DecoderRanker(torch.nn.Module):
    ...
    def mean_pooling(self, last_hidden_state: Tensor, attention_mask: Tensor) -> Tensor:
        ...
        Same as E5Ranker.average_pool but named differently for clarity.
        """
    ...
    def encode(self, batch):
        """
        Forward pass through Qwen3Model.
        CRITICAL: Remove token_type_ids if present - Qwen3 doesn't use them.
        """
