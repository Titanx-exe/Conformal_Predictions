...
def add_anticorrelated_noise_prev_term(optimizer, device, alpha_0=0.5, sigma=1.0):
...
def add_anticorrelated_noise_gradient(optimizer, device, beta_0=0.8, sigma=10.0):
