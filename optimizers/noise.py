...
def add_gausian_noise(optimizer,device,mu=0.0,sigma=50.0):
...
def add_anticorrelated_noise_prev_term(optimizer, device, alpha_0=0.1, sigma=10.0):
...
def add_anticorrelated_noise_gradient(optimizer, device, beta_0=5, sigma=1.0):
